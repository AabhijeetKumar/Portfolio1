        ...
        <div>{PROJECTS.map((project, idx) => (
            <div key={idx} className="mb-8 flex flex-wrap lg:justify-center">
                ...
                <motion.div
                    ...
                    <motion.h6 whileHover={{ scale: 1.1, originX: 0, textShadow: "0px 0px 8px" ,color: "#9333ea"}} className="mb-2 font-semibold"><a href={project.link} target="_blank">{project.title}</a> </motion.h6>
